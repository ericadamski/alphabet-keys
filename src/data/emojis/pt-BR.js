export default {
  ...
  data: {
    'pt-BR': {
      ...
      98: [['🍌', 'banana'], ['👶', 'bebê'], ['🦋', 'borboleta'], ['🥔', 'batata'], ['🥦', 'brócolis'], ['🥖', 'baguete'], ['🥓', 'bacon'], ['🚲', 'bicicleta'], ['🐳', 'Baleia']],
      ...
      107: [['🥝', 'kiwi']],
      108: [['🐺', 'lobo'], ['🦁', 'leão'], ['🌕' ,'lua'], ['💡', 'Lâmpada']],
      109: [['🐵', 'macaco'], ['🦇', 'morcego'], ['🍉', 'melancia'], ['🍎', 'maçã'], ['🍓', 'morango']],
      110: [['👃', 'nariz'], ['🌃', 'noite'], ['☁', 'nuvem']],
      111: [['👂', 'orelha'], ['👁', 'olho'], ['🐑', 'ovelha']],
      112: [['🐼', 'panda'], ['🐷', 'porco'], ['🐧', 'pinguim'], ['🦆', 'pato'], ['🐟', 'peixe'], ['🤡', 'palhaço'], ['🌶', 'Pimenta']],
      113: [['🧀', 'queijo'], ['🔲', 'quadrado'], ['🧩', 'Quebra-cabeça']],
      114: [['🤖', 'robô'], ['🦊', 'raposa'], ['🐭', 'rato'], ['⏰', 'Relógio']],
      115: [['🧜', 'sereia'], ['🍣', 'sushi'], ['🍦', 'sorvete'], ['🐸', 'sapo'], ['🛰️', 'satelite'], ['☀️', 'Sol']],
      116: [['🐆', 'tigre'], ['🐢', 'tartaruga'], ['🌮', 'taco'], ['🚆', 'trem'], ['☎️', 'Telefone']],
      117: [['🦄', 'unicórnio'], ['🍇', 'uva']],
