export default {
  ...
  data: {
    'pt-BR': {
      97: [['⚓️', 'âncora'], ['🍍', 'abacaxi'], ['🚑', 'ambulância'], ['🐝', 'abelha'], ['🥜', 'amendoim'], ['🌈', 'Arco-íris']],
      ...
      107: [['🥝', 'kiwi']],
      108: [['🐺', 'lobo'], ['🦁', 'leão'], ['🌕' ,'lua'], ['💡', 'Lâmpada'], ['🦑', 'Lula']],
      109: [['🐵', 'macaco'], ['🦇', 'morcego'], ['🍉', 'melancia'], ['🍎', 'maçã'], ['🍓', 'morango']],
      110: [['👃', 'nariz'], ['🌃', 'noite'], ['☁', 'nuvem']],
      111: [['👂', 'orelha'], ['👁', 'olho'], ['🐑', 'ovelha']],
      112: [['🐼', 'panda'], ['🐷', 'porco'], ['🐧', 'pinguim'], ['🦆', 'pato'], ['🐟', 'peixe'], ['🤡', 'palhaço'], ['🌶', 'Pimenta'], ['🦚', 'Pavão']],
      113: [['🧀', 'queijo'], ['🔲', 'quadrado'], ['🧩', 'Quebra-cabeça']],
      114: [['🤖', 'robô'], ['🦊', 'raposa'], ['🐭', 'rato'], ['⏰', 'Relógio'], ['🌹', 'Rosa']],
      115: [['🧜', 'sereia'], ['🍣', 'sushi'], ['🍦', 'sorvete'], ['🐸', 'sapo'], ['🛰️', 'satelite'], ['☀️', 'Sol']],
      116: [['🐆', 'tigre'], ['🐢', 'tartaruga'], ['🌮', 'taco'], ['🚆', 'trem'], ['☎️', 'Telefone'], ['☹️', 'Triste'], ['🌍', 'Terra']],
      117: [['🦄', 'unicórnio'], ['🍇', 'uva']],
